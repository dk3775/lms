...
if ($_SESSION['role'] != "Lagos") {
    ...
    $id = $_SESSION['fid'];
    $sql = "SELECT * FROM facultymaster WHERE FacultyId = '$id'";
                            ...
                            <div class="card-body text-center">
                                <div class="row justify-content-center">
                                    <div class="col-12 col-md-12 col-xl-5">
                                        ...
                                        <img src="../src/uploads/facprofile/<?php echo $row['FacultyProfilePic'] . "?t=" . time(); ?>" id="IMG-preview" alt="..." class="img-fluid mb-3 rounded" style="margin:auto; max-width: 80%;">
                                        <!-- Title -->
                                    </div>
                                    <div class="row justify-content-center">
...
if (isset($_POST['subbed'])) {
    ...
    if ($f_error === 0) {
        if ($f_size <= 2000000) {
            if (move_uploaded_file($f_tmp_name, "../src/uploads/facprofile/" . $tt_name)) {
