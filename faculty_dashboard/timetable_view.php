                ...
                <div class="col">
                    ...
                    <div class="row">
                        ...
                        <div class="d-flex justify mb-4">
                            <!-- Button -->
                            <a href="../src/uploads/timetables/<?php echo $row['TimetableImage']; ?>"
                               download="../src/uploads/timetables/<?php echo $row['TimetableImage']; ?>"
                               class="btn btn-success" name="Download">
                                Download
                            </a>
                        </div>
                    </div>
