                    ...
                    <div class="row align-items-center">
                        <div class="col-auto">
                            ...
                            <div class="../avatar avatar-xxl header-avatar-top">
                                <img src="../src/uploads/stuprofile/<?php echo $row['StudentProfilePic']."?t"; ?>" alt="..." class="avatar-img rounded-circle border border-4 border-body">
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-auto mt-2 mt-md-0 mb-md-3">
                            <!-- Button -->
                            <a href="edit_student.php?studentenr=<?php echo $row['StudentEnrollmentNo']; ?>" class="btn btn-warning d-block d-md-inline-block btn-md">
                                Edit Details
                            </a>
                        </div>
                    </div>
