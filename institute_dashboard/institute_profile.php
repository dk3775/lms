						...
						<div class="header-body mt-n5 mt-md-n6">
							<div class="row align-items-center">
								...
								<div class="col-12 col-md-auto mt-2 mt-md-0 mb-md-3">
									<!-- Button -->
									<a href="edit_institute.php?insid=<?php echo $row['InstituteId']; ?>" class="btn btn-primary d-block d-md-inline-block btn-md">
										Edit Details
									</a>
								</div>
							</div>
						...
						<div class="card" data-list='{"valueNames": ["name"]}'>
							<div class="card-body">
								...
								<div class="input-group">
									...
									<input type="text" value="<?php echo $row['InstituteName']; ?>" aria-label="First name" class="form-control" disabled>
								</div>
								<br>
								<div class="input-group">
									<span class="input-group-text col-2 text-dark">User Role</span>
									<input type="text" value="<?php echo $row['InstituteRole']; ?>" aria-label="First name" class="form-control" disabled>
									<span class="input-group-text col-2 text-dark">Institute Office</span>
									<input type="text" value="<?php echo $row['InstituteOffice']; ?>" aria-label="Last name" class="form-control disable" disabled>
								</div>
								
								<br>
								<div class="input-group">
									<span class="input-group-text col-2 text-dark">E-mail</span>
									<input type="text" value="<?php echo $row['InstituteEmail']; ?>" aria-label="Last name" class="form-control disable" disabled>
									<span class="input-group-text col-2 text-dark">Contact No.</span>
                                    <input type="text" value="<?php echo $row['InstituteContactNo']; ?>" aria-label="First name" class="form-control" disabled>
								</div>
								
								<br>
								<div class="input-group  input-group-lg mb-3">
									<span class="input-group-text col-2 text-dark">Address</span>
									<input type="text" value="<?php echo $row['InstituteAddress']; ?>" aria-label="Last name" class="form-control disable" disabled>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="card">
							<div class="card-body">
								<div class="row align-items-center">
									...
									<div class="col-auto">
										<!-- Button -->
										<a href="institute_profile.php?insid=<?php echo $row['InstituteId']; ?>" class="btn btn-m btn-primary d-none d-md-inline-block">
										View
										</a>
									</div>
								</div>
