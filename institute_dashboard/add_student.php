                ...
                <div class="col-12 col-lg-10 col-xl-8">
                    ...
                    <form method="POST" enctype="multipart/form-data" class="row g-3 needs-validation" novalidate>
                            ...
                            <div class="col">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        ...
                                        <!-- Avatar -->
                                        <div class="avatar">
                                            <img name="StuIMG" class="avatar-img rounded-circle"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="validationCustom01" name="mname"
                                        required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="validationCustom01" name="lname"
                                        required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <!-- Input -->
                                    <input type="email" class="form-control" id="validationCustom01" name="semail"
                                        required>
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                ...
                                <input type="tel" pattern="[0-9]{10}" maxlength="10" id="validationCustom01"
                                    class="form-control" name="scontact" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12 col-md-6">
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="tel" id="validationCustom01" maxlength="10" class="form-control"
                                        pattern="[0-9]{10}" name="pcontact" required>
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                <label for="validationCustom01" class="form-label">
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="myInput" oninput="cp()" type="tel" pattern="[0-9]{12}"
                                        id="validationCustom01" class="form-control" name="senr" required>
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="tel" maxlength="3" id="validationCustom01" class="form-control"
                                        name="sroll" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="validationCustom01" class="form-control" name="sbranch"
                                        required>
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-auto col-6">
                                <div class="input-group input-group-sm mb-3 ">
                                    <textarea id="demo" class="form-control fs-2" name="ec" readonly
                        ...
                        <div class="row">
                            ...
                            <div class="col-auto col-6">
                                <div class="input-group input-group-sm mb-3">
                                    <textarea type="text" class="form-control" readonly name="spassword"
...
if (isset($_POST['subbed'])) {
	...
	$sql = "INSERT INTO studentmaster (StudentDOB, StudentEnrollmentNo, StudentPassword, StudentFirstName, StudentMiddleName, StudentLastName, StudentProfilePic, StudentBranch, StudentSemester, StudentEmail, StudentContactNo, StudentAddress, ParentEmail, ParentContactNo, StudentRollNo) 
	VALUES ('$dob','$senr','$spass','$fname','$mname','$lname','$fs_name','$sbranch','$ssem','$semail','$scontact','$add','$pmail','$pcontact','$sroll');";
