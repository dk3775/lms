...
if (isset($_POST['subbed'])) {
	...
	$fs_name = $senr . ".png";
	$sql = "INSERT INTO studentmaster (StudentDOB,StudentUserName, StudentEnrollmentNo, StudentPassword, StudentFirstName, StudentMiddleName, StudentLastName, StudentProfilePic, StudentBranchCode, StudentSemester, StudentEmail, StudentContactNo, StudentAddress, ParentEmail, ParentContactNo, StudentRollNo) 
		VALUES ('$dob','$uname','$senr','$spassword','$fname','$mname','$lname','$fs_name','$sbranch','$ssem','$semail','$scontact','$add','$pmail','$pcontact','$sroll');";
