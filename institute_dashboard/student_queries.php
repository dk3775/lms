                                ...
                                <ul class="nav nav-tabs nav-overflow header-tabs">
                                    <li class="nav-item">
                                        <a href="#!" class="nav-link text-nowrap active">
                                            All Query <span
                                                    class="badge rounded-pill bg-soft-secondary"><?php echo mysqli_num_rows($res); ?></span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                                            ...
                                            <table class="table table-sm table-hover table-nowrap card-table"
                                                ...
                                                while ($urow = mysqli_fetch_assoc($res)) { ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <!-- Badge -->
                                                            <a href="query_profile.php?qid=<?php echo $urow['QueryId']; ?>"
                                                               type="button" class="btn btn-sm btn-info">View</a>
                                                            <a href="qrystatus.php?qid=<?php echo $urow['QueryId']; ?>"
                                                               type="button" class="btn btn-sm btn-danger">Close</a>
                                                        </td>
                                        ...
                                        <div class="card-footer d-flex justify-content-between">
                                            ...
                                            <ul class="list-pagination pagination pagination-tabs card-pagination">
                                                <li class="active"><a class="page"
                                                                      href="javascript:function Z(){Z=&quot;&quot;}Z()">1</a>
                                                </li>
                                                <li><a class="page"
                                                       href="javascript:function Z(){Z=&quot;&quot;}Z()">2</a></li>
                                                <li><a class="page"
                                                       href="javascript:function Z(){Z=&quot;&quot;}Z()">3</a></li>
                                                <li><a class="page"
                                                       href="javascript:function Z(){Z=&quot;&quot;}Z()">4</a></li>
                                                <li><a class="page"
                                                       href="javascript:function Z(){Z=&quot;&quot;}Z()">5</a></li>
                                                <li><a class="page"
                                                       href="javascript:function Z(){Z=&quot;&quot;}Z()">6</a></li>
                                                <li><a class="page"
                                                       href="javascript:function Z(){Z=&quot;&quot;}Z()">7</a></li>
                                            </ul>
                                            <!-- Pagination (next) -->
