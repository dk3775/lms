...
while ($urow = mysqli_fetch_assoc($ures)) {?>
                                    <tr>
                                       ...
                                       <td>
                                          <!-- Badge -->
                                          <a href="edit_update.php?updid=<?php echo $urow['UpdateId']; ?>" type="button" class="btn btn-sm btn-outline-primary">Edit</a> &nbsp;

                                          <!-- Badge -->
                                          <a download="../src/uploads/updates/<?php echo $urow['UpdateFile']; ?>" href="../src/uploads/updates/<?php echo $urow['UpdateFile']; ?>" type="button" class="btn btn-sm btn-outline-primary">Download</a>
                                       </td><td></td>
