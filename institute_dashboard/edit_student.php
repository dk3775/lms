						...
						?>
							<form method="POST" enctype="multipart/form-data">
								...
								<div class="row">
									<div class="col-12 col-md-6">
										<div class="form-group">
											...
											<input type="tel" oninput="cp();" pattern="[0-9]{12}" class="form-control" name="senr" value="<?php echo $row['StudentEnrollmentNo']; ?>" required>
										</div>
									</div>
									<div class="col-12 col-md-6">
										<div class="form-group">
								...
								<div class="row">
									...
									<div class="col-auto col-6">
										<div class="input-group input-group-sm mb-3 ">
											<textarea id="demo" class="form-control fs-2" name="uname"><?php echo $row['StudentUserName']; ?></textarea>
								...
								<div class="row">
									...
									<div class="col-auto col-6">
										<div class="input-group input-group-sm mb-3">
											<textarea class="form-control" name="spassword" id="myInput2"><?php echo $row['StudentPassword']; ?></textarea>
