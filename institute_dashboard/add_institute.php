                     ...
                     <div class="row">
                        <div class="col-12 col-md-6">
                           <div class="form-group">
							  ...
							  <input type="text" class="form-control" id="validationCustom01" value="IN" name="inusername"
                                 required> </div>
                        </div>
                        <div class="col-12 col-md-6">
                           <label for="validationCustom01" class="form-label">
                           Password
                             ...
                             <input type="password" class="form-control" id="validationCustom01" name="inpass"
                                 required>
                        </div>
                     </div>
                     <hr class="md-5">
                     ...
                     <div class="row">
                        <div class="col-12 col-md-6">
                           ...
                           <div class="form-group">
                              ...
                              <!-- Input -->
                              <input type="email" class="form-control" id="validationCustom01" name="inemail"
                                 required>
                           </div>
                        </div>
                        <div class="col-12 col-md-6">
