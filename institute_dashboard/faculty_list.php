...
if ($_SESSION['role'] != "Texas") {
    ...
    $qur = "SELECT * FROM facultymaster ORDER BY FacultyFirstName";
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <div class="avatar avatar-xs align-middle mr-2">
                                                    <img class="avatar-img rounded-circle" src="../src/uploads/facprofile/<?php echo $row['FacultyProfilePic']."?t"; ?>" alt="...">
                                                </div>
                                            ...
                                            <td>
                                                <a href="edit_faculty.php?facid=<?php echo $row['FacultyId']; ?>" class="btn btn-sm btn-warning">
                                                    Edit
                                                </a>
                                                &nbsp;
                                                <a class="btn btn-sm btn-danger" href="fdelete.php?facid=<?php echo $row['FacultyId']; ?>" onclick="if (! confirm('Are You Sure, You want to Delete this Faculty ?')) return false;">
                                                    Delete
                                                    <!--changes-->
                                                </a>
                                                &nbsp;
                                                <a href="faculty_profile.php?facultycode=<?php echo $row['FacultyId']; ?>" class="btn btn-sm btn-info">
                                                    View
                                                </a>
                                            </td>
                                            <td class="text-right">
